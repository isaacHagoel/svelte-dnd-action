...
| `transformDraggedElement` | Function       | No                                                           | `undefined`                                       | A function that is invoked when the draggable element is created on drag start. It passes in the element being dragged as the first parameter, and the index of item from the items array as the second parameter. This allows you to override any fields on the element, such as changing the innerHTML. |
