...
| `zoneTabIndex` | Number | No | `0` | Allow user to set custom tabindex to the list container. Can be useful if you want to make the screen reader to skip the list container. You can change it at any time. |
